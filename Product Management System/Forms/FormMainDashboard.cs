...
using System.Collections.Generic;
using System.ComponentModel;
using System.Configuration; // 🟢 បន្ថែមហ្វាយន័រនេះដើម្បីអាន App.config
using System.Data;
using System.Data.SqlClient;
using System.Drawing;
using System.Linq;
...
namespace Product_Management_System.Forms
{
    public partial class FormMainDashboard : Form
    {
        // 🟢 ទាញយក Connection String ពី App.config មកទុកប្រើប្រាស់រួម
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            if (dgv.SelectedRows.Count > 0)
            {
                ...
                FormEditProduct editForm = new FormEditProduct(id, name, price, stock, categoryId);
                editForm.ShowDialog();
                LoadProducts(); // 🟢 បន្ថែម LoadProducts ទីនេះស្រាប់ពេល Edit រួច
            }
            else
            {
                MessageBox.Show("Please select a product to edit!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnCategorise_Click(object sender, EventArgs e)
        {
            Categorise catForm = new Categorise();
            catForm.ShowDialog();
            LoadCategoriesToComboBox(); // 🟢 Refresh Category ក្រោយពេលកែសម្រួល Category
        }
        ...
        private void btnRefresh_Click_1(object sender, EventArgs e)
        {
            try
            {
                // 🟢 កែសម្រួលឱ្យហៅទិន្នន័យមកវិញពិតប្រាកដ
                LoadProducts();
                LoadCategoriesToComboBox();
